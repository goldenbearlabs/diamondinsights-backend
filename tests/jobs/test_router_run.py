...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("game_boxscore_sync", {"reload_all_games": True, "season": "2024"}, "apps.jobs.game_boxscore_sync", "GameBoxscoreSync", {"season_year": 2024, "rerun_all_boxscores": 1}),
        ("game_boxscore_sync", {}, "apps.jobs.game_boxscore_sync", "GameBoxscoreSync", {"season_year": 2026, "rerun_all_boxscores": 0}),
        ("market_sync", {}, "apps.jobs.market_sync", "MarketSync", {}),
        ("market_candle_sync", {}, "apps.jobs.market_candle_sync", "MarketCandleSync", {}),
        ("player_sync", {"rerun_all_cards": "yes"}, "apps.jobs.player_sync", "PlayerSync", {"rerun_all_cards": True}),
        ("player_sync", {}, "apps.jobs.player_sync", "PlayerSync", {"rerun_all_cards": False}),
        ("prediction_sync", {}, "apps.jobs.prediction_sync", "PredictionSync", {}),
        ("show_game_refresh", {}, "apps.jobs.show_game_refresh", "ShowGameRefresh", {}),
        ("show_game_refresh_enqueue", {}, "apps.jobs.show_game_refresh", "ShowGameRefreshEnqueuer", {}),
        ("show_game_refresh_username", {"username": "player1"}, "apps.jobs.show_game_refresh", "ShowGameRefresh", {"usernames": ["player1"]}),
        ("show_game_agg", {}, "apps.jobs.show_game_agg", "ShowGameAgg", {}),
        ("show_game_agg_enqueue", {}, "apps.jobs.show_game_agg", "ShowGameAggEnqueuer", {}),
        ("show_game_agg_batch", {"game_ids": ["g1", "g2"]}, "apps.jobs.show_game_agg", "ShowGameAgg", {"game_ids": ["g1", "g2"]}),
        ("show_profile_refresh_enqueue", {}, "apps.jobs.show_profile_refresh", "ShowProfileRefreshEnqueuer", {}),
        ("show_profile_refresh_username", {"username": "player1"}, "apps.jobs.show_profile_refresh", "ShowProfileStatsUpdater", {"usernames": ["player1"]}),
